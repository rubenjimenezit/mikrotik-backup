# jun/28/2020 15:11:01 by RouterOS 6.45.5
...
add action=accept chain=input comment="Accept Winbox" dst-port=8291-8299 \
    protocol=tcp
add action=accept chain=input comment="Accept SSH from VPN L2TP" dst-port=22 \
    protocol=tcp src-address=10.35.0.0/24
